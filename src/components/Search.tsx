...
const Search = () => {
  ...
  return (
    <div className='relative rounded-md border border-gray-500 py-3 pl-3 pr-2 shadow-sm focus-within:border-[#134097] focus-within:ring-1 focus-within:ring-[#134097] sm:mb-6 xs:mb-2 w-full sm:w-3/5'>
      <label
        htmlFor='name'
